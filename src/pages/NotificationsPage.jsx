          ...
          <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
            {notifications.map((notif) => {
              ...
              return (
                <div
                  key={notif.id}
                  className={`flex items-start gap-4 p-4 px-2 rounded-xl shadow-sm border border-gray-200 bg-white hover:shadow-md transition-all duration-300 border-l-4 ${styles.border}`}
                >
                  {/* Icon */}
